...
**Complete quiz → onboarding → home → daily brief (Align / Act / Reflect) to build streak.**
...
Minimize steps and cognitive load to complete the daily loop. Every screen should have one clear primary action; secondary actions stay visually de-emphasized.
